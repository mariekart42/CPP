...
ClapTrap::ClapTrap(void):
	...
	_attackDamage(20)
{
	std::cout << "\033[32m" << "NONAME ClapTrap Constructor!" << "\033[0m" << std::endl;
}
...
ClapTrap::ClapTrap(std::string name):
	...
	_attackDamage(20)
{
	std::cout << "\033[32m" << _name << " ClapTrap Constructor!" << "\033[0m" << std::endl;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << "\033[31m" << _name << " ClapTrap Deconstructor!" << "\033[0m" << std::endl;
}
